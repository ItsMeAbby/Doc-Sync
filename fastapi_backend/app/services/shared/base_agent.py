...
class BaseAgent:
    ...
    def __init__(self, name: str, instructions: str, output_type: Type[T], tools: Optional[List[Any]] = None):
...
class AgentFactory:
    ...
    @staticmethod
    def create_agent(name: str, instructions: str, output_type: Type[T], tools: Optional[List[Any]] = None) -> BaseAgent:
