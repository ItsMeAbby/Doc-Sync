...
async def get_document_by_version_core(
    ...
    try:
        ...
        return DocumentDetailResponse(
            success=True, message="Document retrieved successfully", document=document
        )
    except Exception as e:
        return DocumentDetailResponse(success=False, message=str(e), document=None)
...
async def get_all_document_paths_core(is_api_ref: bool = False) -> PathListResponse:
    ...
    try:
        ...
        return PathListResponse(
            success=True, message=f"Found {len(paths)} document paths", paths=paths
        )
    except Exception as e:
        return PathListResponse(success=False, message=str(e), paths=[])


async def search_similar_documents_core(
    ...
    try:
        ...
        return DocumentListResponse(success=False, message=str(e), documents=[])
