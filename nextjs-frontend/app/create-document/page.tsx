      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Create a new document or parent folder for your documentation.
          </p>
        </div>
        ...
        <Tabs
          value={activeTab}
          onValueChange={(value) =>
            setActiveTab(value as "parent" | "document")
          }
        >
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Create a new parent container for organizing documents
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        This will be used to generate the URL path (e.g.,
                        "api-reference/")
                      </p>
                    </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Create a new documentation page with content
                    </p>
                  </div>
                </div>
                          ...
                          <Select
                            ...
                            onValueChange={(parentId) => {
                              ...
                              if (parentId && documentIsApiRef) {
                                const selectedParent = parentDocuments.find(
                                  (p) => p.id === parentId,
                                );
                                if (
                                  selectedParent &&
                                  !selectedParent.is_api_ref
                                ) {
                      ...
                      <div className="flex items-center space-x-3">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            setDocumentIsApiRef(checked === true)
                          }
                        />
                        <Label
                          htmlFor="documentIsApiRef"
                          className="text-sm font-medium text-gray-900 dark:text-white"
                        >
